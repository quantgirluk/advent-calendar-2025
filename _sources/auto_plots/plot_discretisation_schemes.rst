...
.. "auto_plots/plot_discretisation_schemes.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_plots_plot_discretisation_schemes.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_plots_plot_discretisation_schemes.py:


Discretisation Schemes
======================

.. GENERATED FROM PYTHON SOURCE LINES 8-197
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_plots/images/sphx_glr_plot_discretisation_schemes_001.png
         :alt: Discretisation Schemes for Geometric Brownian Motion, Grid points N=10, Grid points N=50, Grid points N=100
         :srcset: /auto_plots/images/sphx_glr_plot_discretisation_schemes_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_plots/images/sphx_glr_plot_discretisation_schemes_002.png
         :alt: Strong Convergence for GBM
         :srcset: /auto_plots/images/sphx_glr_plot_discretisation_schemes_002.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_plots_plot_discretisation_schemes.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_discretisation_schemes.ipynb <plot_discretisation_schemes.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_discretisation_schemes.py <plot_discretisation_schemes.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_discretisation_schemes.zip <plot_discretisation_schemes.zip>`
