...
.. "auto_plots/plot_compound_effect.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_plots_plot_compound_effect.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_plots_plot_compound_effect.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_plots/images/sphx_glr_plot_compound_effect_001.png
         :alt: The Compounding Effect   Annual contributions of \$5000 and 8.0$\%$ Rate
         :srcset: /auto_plots/images/sphx_glr_plot_compound_effect_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_plots/images/sphx_glr_plot_compound_effect_002.png
         :alt: The Compounding Effect   Annual contributions of \$5000 and 4.0$\%$ Rate
         :srcset: /auto_plots/images/sphx_glr_plot_compound_effect_002.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_plots_plot_compound_effect.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_compound_effect.ipynb <plot_compound_effect.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_compound_effect.py <plot_compound_effect.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_compound_effect.zip <plot_compound_effect.zip>`
